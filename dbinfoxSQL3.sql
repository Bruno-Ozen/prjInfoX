...
CREATE TABLE IF NOT EXISTS `dbinfox`.`telefone` (
  ...
  INDEX `fk_telefone_tbusuarios1_idx` (`iduser` ASC) VISIBLE,
  INDEX `fk_telefone_tbclientes1_idx` (`idtcli` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `dbinfox`.`email` (
  ...
  `dtcli` INT NOT NULL,
  PRIMARY KEY (`idemail`),
  INDEX `fk_email_tbusuarios1_idx` (`iduser` ASC) VISIBLE,
  INDEX `fk_email_tbclientes1_idx` (`dtcli` ASC) VISIBLE,
